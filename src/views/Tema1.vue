  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      SlyderA(tipo="b")(data-aos="flip-right")
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p El uso del carbón en las plantas termoeléctricas para la generación de energía eléctrica y en la industria del cemento y ladrillos, donde se requieren altos consumos de energía, contribuye significativamente a la emisión de gases de efecto invernadero, como el dióxido de carbono, que está relacionado con el cambio climático.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema1/img18.png', alt='Carbón')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Petróleo
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p El petróleo y sus derivados, como la gasolina, son ampliamente utilizados en la industria del transporte, lo que genera emisiones significativas de gases de efecto invernadero, como el dióxido de carbono. Estas emisiones contribuyen al cambio climático y al calentamiento global.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema1/img19.png', alt='Petróleo')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Gas natural
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Al igual que el petróleo, se utiliza como fuente de energía en el sector del transporte, incluyendo vehículos y aviones. Su quema también genera emisiones de gases de efecto invernadero, contribuyendo al cambio climático.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema1/img20.png', alt='Gas natural')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Rellenos sanitarios
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Son fuentes significativas de emisiones de gas metano, un potente gas de efecto invernadero. Esto ocurre debido a la descomposición de los residuos orgánicos en un ambiente sin oxígeno.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema1/img21.png', alt='Petróleo')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Tratamiento de aguas residuales
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Es una fuente de emisiones de gases de efecto invernadero, como el dióxido de carbono y el metano. Estas emisiones pueden ocurrir durante el proceso de purificación del agua debido a la liberación de gases atrapados en las aguas residuales.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema1/img22.png', alt='Tratamiento de aguas residuales')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Deforestación
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Es una de las principales causas del cambio climático, ya que la eliminación de árboles reduce la capacidad de la Tierra para absorber dióxido de carbono, un gas de efecto invernadero. Cuando los árboles se talan o queman, el carbono que almacenaban se libera a la atmósfera, contribuyendo al calentamiento global. Además, la deforestación también destruye hábitats naturales y amenaza la biodiversidad.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema1/img23.png', alt='Deforestación')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Ganadería
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Es otra actividad que contribuye significativamente a la emisión de gases de efecto invernadero, especialmente el metano. Los animales rumiantes, como las vacas, producen metano durante su proceso digestivo, lo que se conoce como fermentación entérica. Además, el almacenamiento y manejo de estiércol animal también puede generar emisiones de metano y óxido nitroso, otro gas de efecto invernadero.
          .col-md-6
            figure
      ...
      .col-lg-8(data-aos="flip-right")
        .cajon.color-primario.p-4.mb-4
          ol.lista-ol
            ...
            li
              span.text-bold 2. 
              | Escasez de agua debido a la acidificación y contaminación debido al aumento del dióxido de carbono.
            li
              span.text-bold 3. 
              | Aumento de los fenómenos meteorológicos como huracanes, ciclones, aumento de lluvias o sequías extremas.
            li
              span.text-bold 4. 
              | Graves incendios.
            li
            ...
            li
              span.text-bold 6. 
              | Aumento del nivel del mar, inundaciones de zonas costeras.
            li
              span.text-bold 7. 
            ...
            li
              span.text-bold 9.               
              | Aparición de enfermedades peligrosas para el ser humano.
            li
              span.text-bold 10. 
              | Pérdida de recursos naturales necesarios para el desarrollo de la vida en el planeta.
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-7(data-aos="flip-right")
        ...
        .bloque-texto-b.color-primario
          .bloque-texto-b__texto        
            p Entre las medidas de adaptación se incluye la diversificación de cultivos para hacer frente a climas cambiantes, la inversión en investigación y desarrollo para prevenir catástrofes naturales, la restauración de ecosistemas dañados, la construcción de edificaciones e infraestructuras más seguras y sostenibles, la reforestación de bosques y la elaboración de protocolos para situaciones de emergencia climática. Estas acciones son fundamentales para reducir los impactos del cambio climático y aumentar la resiliencia de las comunidades y los ecosistemas.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5
        LineaTiempoD.color-primario.mb-4
          .row(numero="1" titulo="Transición a fuentes de energía limpia")
            .col-md-12.mb-4.mb-md-0          
              p Promover el uso de energías renovables como la solar y la eólica en lugar de depender de combustibles fósiles, que son una fuente importante de emisiones de gases de efecto invernadero.
          .row(numero="2" titulo="Eficiencia energética")
            .col-md-12.mb-4.mb-md-0          
              p Mejorar la eficiencia en el consumo de energía en edificaciones, vehículos y procesos industriales para reducir la cantidad de energía necesaria y, por lo tanto, las emisiones.
          .row(numero="3" titulo="Transporte sostenible")
            .col-md-12.mb-4.mb-md-0          
              p Fomentar el uso del transporte público, bicicletas y vehículos eléctricos en lugar de automóviles que funcionen con combustibles fósiles.
          .row(numero="4" titulo="Reforestación y conservación de bosques")
            .col-md-12.mb-4.mb-md-0          
              p Plantar árboles y proteger los bosques existentes, ya que estos actúan como sumideros de carbono, absorbiendo dióxido de carbono de la atmósfera.
          .row(numero="5" titulo="Gestión de residuos")
            .col-md-12.mb-4.mb-md-0          
              p Fomentar el reciclaje y la reducción de residuos sólidos, así como la captura y eliminación adecuada del gas metano producido en vertederos.
          .row(numero="6" titulo="Agricultura sostenible")
            .col-md-12.mb-4.mb-md-0          
              p Promover prácticas agrícolas que reduzcan las emisiones de gases de efecto invernadero, como la agricultura de conservación y la reducción de la deforestación para expandir la agricultura.
          .row(numero="7" titulo="Tecnología de captura y almacenamiento de carbono")
            .col-md-12.mb-4.mb-md-0          
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        p Estas acciones son esenciales para limitar el calentamiento global y reducir los impactos negativos del cambio climático en el planeta. La mitigación es un componente clave de la lucha contra el cambio climático y requiere la colaboración de gobiernos, empresas y ciudadanos en todo el mundo.
</template>
