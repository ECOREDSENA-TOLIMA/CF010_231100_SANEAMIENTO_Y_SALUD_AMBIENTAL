  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5
      ...
      .bloque-texto-g__texto.p-4
        p.mb-0 La normatividad relacionada con el cambio climático comprende una serie de acuerdos y leyes a nivel internacional y nacional que establecen directrices para abordar el cambio climático. El Acuerdo de París, adoptado en 2015, es un ejemplo clave, donde los países se comprometen a limitar el aumento de la temperatura global. Además, el Protocolo de Kioto, establecido en 1997, fue un hito importante en la reducción de emisiones. A nivel nacional, cada país puede tener su propia legislación relacionada con el cambio climático. Además, las regulaciones y políticas locales, las iniciativas de sostenibilidad corporativa y otras medidas contribuyen a abordar este desafío global. Esta normatividad es esencial para guiar y regular las acciones en la lucha contra el cambio climático.
    Separador
    .row
      .col-xl-12       
      ...
      SlyderA(tipo="b")(data-aos="flip-right")
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Adoptar políticas nacionales y medidas para mitigar el cambio climático, por medio de la limitación de las emisiones de gases de efecto invernadero, protegiendo y mejorando sus sumideros y depósitos de gases.
                p Con esto, los países desarrollados demuestran el liderazgo en el manejo de la mitigación del cambio climático, acordes con el objetivo de esta convención.
          .col-md-6
            figure
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Se tendrán en cuenta los conocimientos científicos más precisos para realizar los cálculos del punto anterior y la convención define la metodología más apropiada.
          .col-md-6
            figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-6
        ul.lista-ul
          ...
          li 
            i.lista-ul__vineta
            | Países con zonas áridas y semiáridas, zonas expuestas al deterioro forestal.
          li 
            i.lista-ul__vineta
            | Países con zonas probables a desastres naturales.
          li 
            i.lista-ul__vineta
            | Países con zonas vulnerables a sequías y desertificación.
          li 
            i.lista-ul__vineta
            | Países con zonas de alta contaminación atmosférica urbana.
          li 
            i.lista-ul__vineta
            | Países con ecosistemas frágiles.
          li 
            i.lista-ul__vineta
            | Países que dependen de ingresos generados por la producción, procesamiento y exportación de combustibles fósiles.
          li 
            i.lista-ul__vineta
            | Países sin litoral.
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-sm-6.col-lg-4.mb-4.mb-sm-0
        .tarjeta.color-secundario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/tema2/img16.svg', alt='Imagen decorativa')
      ...
      .col-sm-6.col-lg-4.mb-4.mb-sm-0
        .tarjeta.color-secundario.p-4
          .row.justify-content-center.mb-3
            .col-7
              figure
                img(src='@/assets/curso/temas/tema2/img17.svg', alt='Imagen decorativa')
    ...
    .tarjeta.tarjeta--verde.p-4.mb-4(style="background-color:#EEFFDE")
      SlyderA(tipo="b")(data-aos="flip-right")
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Equipos de refrigeración y aire acondicionado
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Los productos fabricados en espuma, como envases y almohadas, a menudo utilizan poliestireno expandido o espuma de poliuretano. Estos materiales son no biodegradables y pueden persistir en el medio ambiente durante siglos, contribuyendo a la contaminación.
          .col-md-6
            figure
              img(src='@/assets/curso/temas/tema2/img19.png', alt='Imagen decorativa')
        .row
          .col-md-6.mb-4.mb-md-0
            h3 Productos de limpieza
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Como los solventes que son sustancias líquidas utilizadas para disolver otras sustancias, formando una solución. Su capacidad para disolver materiales los hace esenciales en procesos industriales y domésticos, pero algunos pueden ser tóxicos y deben manejarse con precaución.
          .col-md-6
            figure
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Las pinturas pueden afectar al medio ambiente debido a la liberación de compuestos orgánicos volátiles durante su aplicación, lo que contribuye a la contaminación del aire y la formación de #[i smog].
          .col-md-6
            figure
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Los fumigantes agrícolas, como el metil bromuro o el fosfuro de aluminio, pueden tener efectos perjudiciales en el medio ambiente. Pueden contaminar el suelo y el agua, dañar la biodiversidad y liberar gases tóxicos en la atmósfera.
          .col-md-6
            figure
        ...
        .row
          .col-md-6.mb-4.mb-md-0
            ...
            .row.mb-5
              .col-sm.mb-5.mb-sm-0
                p Como la extracción de minerales, la producción de petróleo y la tala de bosques impactan negativamente en el ambiente. Provocan la degradación del suelo, la contaminación del agua y la emisión de gases de efecto invernadero, contribuyendo al cambio climático y la pérdida de biodiversidad, lo que exige prácticas sostenibles y una gestión responsable.
          .col-md-6
            figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10.desktop
        ImagenInfografica.color-acento-botones.mb-5
          ...
          .tarjeta.color-fondo.p-3(x="15%" y="45%" numero="1")
            .h5.mb-2 
            p Seguir elaborando políticas y medidas acordes a las particularidades de su país.
          .tarjeta.color-fondo.p-3(x="23%" y="22%" numero="2")
            .h5.mb-2 
            p Fomentar la eficiencia energética.
          .tarjeta.color-fondo.p-3(x="50%" y="6%" numero="3")
            .h5.mb-2 
            p Proteger y mejorar los sumideros y depósitos de gases de efecto invernadero.
          .tarjeta.color-fondo.p-3(x="76%" y="20%" numero="4")
            .h5.mb-2 
            p Promover prácticas sostenibles de gestión forestal, forestación y reforestación.
          .tarjeta.color-fondo.p-3(x="85%" y="45%" numero="5")
            .h5.mb-2 
            p Promover prácticas agrícolas sostenibles.
          .tarjeta.color-fondo.p-3(x="81%" y="70%" numero="6")
            .h5.mb-2 
            p Investigar, promover y desarrollar nuevas formas de energía renovable y el uso de tecnologías avanzadas para la captura de CO2 son acciones fundamentales para abordar el cambio climático de manera sostenible.
          .tarjeta.color-fondo.p-3(x="63%" y="92%" numero="7")
            .h5.mb-2 
            p Reducir o eliminar dificultades del mercado.
          .tarjeta.color-fondo.p-3(x="50%" y="94%" numero="8")
            .h5.mb-2 
            p Fomentar reformas apropiadas para promover las políticas y medidas que limiten o reduzcan las emisiones de gases de efecto invernadero no controlados por el Protocolo de Montreal.
          .tarjeta.color-fondo.p-3(x="36%" y="90%" numero="9")
            .h5.mb-2 
            p Proponer medidas para limitar y reducir las emisiones de los gases de efecto invernadero producto de actividades del sector transporte.
          .tarjeta.color-fondo.p-3(x="20%" y="70%" numero="10")
            .h5.mb-2 
          ...
          .col-lg-10
            ...
            ul.lista-ul
              li
                ...
                | Fuentes de emisión de GEI en el sector rural: quema de combustibles fósiles, quema de biomasa, manejo de estiércol, quema de residuos agrícolas, deforestación, abandono de tierras cultivadas.
              li
                i.fas.fa-check.text-vineta
                | Líneas de acción propuestas:  promover prácticas agrícolas sostenibles, reducir la quema de biomasa, mejorar la gestión de residuos agrícolas y reforestar áreas deforestadas.                
        ...
        .row.justify-content-center.align-items-center.mb-5
          ...
          .col-lg-10
            ...
            ul.lista-ul
              li
                i.fas.fa-check.text-vineta
                | Fuentes de emisión de GEI en el sector urbano: emisión de gases del transporte, emisión de gases industriales, generación y tratamiento de residuos sólidos y líquidos, utilización de solventes y consumo energético de edificios.
              li
                i.fas.fa-check.text-vineta
                | Líneas de acción propuestas: fomentar el transporte público sostenible, reducir la emisión de gases industriales, mejorar la gestión de residuos y promover la eficiencia energética en edificios.
        hr
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-1.col-6
            figure
          ...
          .col-lg-10
            ...
            ul.lista-ul
              li
                i.fas.fa-check.text-vineta
                | Fuentes de emisión de GEI en el sector minero-energético: quema de combustibles fósiles, emisiones de actividades de explotación de petróleo, gas natural y carbón, emisiones en la producción de cemento, hierro, acero y papel.
              li
                i.fas.fa-check.text-vineta
                | Líneas de acción propuestas: integrar la adaptación al cambio climático en el sector energético, fomentar el uso de biocombustibles, diversificar la producción de energía y gestionar las emisiones en sectores de minas e hidrocarburos.
        hr
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-1.col-6
            figure
          ...
          .col-lg-10
            ...
            ul.lista-ul
              li
                i.fas.fa-check.text-vineta
                | Fuentes de emisión de GEI en el sector de infraestructura: quema de combustibles en transporte, deforestación para obras de regulación hídrica, emisiones de industrias de cemento, hierro y acero.
              li
                i.fas.fa-check.text-vineta
                | Líneas de acción propuestas: incorporar medidas de mitigación en el diseño de infraestructuras, evaluar la vulnerabilidad de la infraestructura de transporte y fomentar alianzas público-privadas en el sector de transporte.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5
        figure
          img(src='@/assets/curso/temas/tema2/img36.svg', alt='Imagen decorativa')
      .col-lg-5
        LineaTiempoD.color-primario.mb-4
          .row(numero="1" titulo="Ecosistemas")
          ...
          .row(numero="2" titulo="Clima")
            .col-md-12.mb-4.mb-md-0          
              p En la gestión de manejo, conservación y restauración de ecosistemas tener en cuenta los ecosistemas vulnerables al cambio climático.
          .row(numero="3" titulo="Reducción")
            .col-md-12.mb-4.mb-md-0          
              p Definir e incluir en la planificación acciones de manejo y conservación de los ecosistemas y sus servicios ecosistémicos porque reducen las emisiones de GEI.
